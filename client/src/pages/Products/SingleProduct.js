                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="bg-white p-3">
                                <p>
                                    Quis dolore consequat commodo cillum exercitation nisi laborum
                                    esse ipsum magna incididunt ut dolore.Eu laboris mollit laboris
                                    excepteur eu ullamco do laboris culpa ad.Aute ea quis ullamco ex
                                    cillum in ex dolore cupidatat.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="reviews mt-4">
                                    <div className="review">
                                        ...
                                        <p className="mt-3">
                                            ...
                                            Lorem.Occaecat veniam elit irure veniam incididunt
                                            cillum exercitation adipisicing fugiat cupidatat Lorem.
                                        </p>
                                    </div>
                                </div>
                            </div>
